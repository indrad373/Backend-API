...
<div id="container">
	...
	<div id="body">
        ...
        <p>API Purpose : </p>
		<code>API ini digunakan untuk melihat item promo</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/item-view-promo</code>

        <p>Test Case : </p>
		<code>
            {
                http://localhost/MMart-api/api/item-view-promo
            }
        </code>
