...
<div id="container">
	...
	<div id="body">
        ...
        <p>API Purpose : </p>
		<code>API ini digunakan untuk mengubah data item</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/item-update</code>
		...
		<code>
            {
                "item_name": "Marimas",
			    "description": "Untuk menyegarkan tenggorokan",
			    "price": "1000",
			    "stock": "3"
            }
        </code>
