...
<div id="container">
	...
	<div id="body">
        ...
        <p>API Purpose : </p>
		<code>API ini digunakan untuk menambah store</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/store-insert</code>
