...
<div id="container">
	...
	<div id="body">
        ...
        <p>Testing Tool : <b>Postman</b></p>

        <p>API Purpose : </p>
		<code>API ini digunakan untuk melakukan login user</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/user-login</code>
		...
		<code>
            {
    			...
    			<p>Type: Error</p>
    			<p>Message: Call to undefined method User::print_response()</p>
    			<p>Filename: C:\xampp\htdocs\online-store-api\application\controllers\mobile\User.php</p>
    			<p>Line Number: 49</p>
    			<p>Backtrace:</p>
    			<p style="margin-left:10px">
				File: C:\xampp\htdocs\online-store-api\index.php
        		<br />
				Line: 315
        		<br />
