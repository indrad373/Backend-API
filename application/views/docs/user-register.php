...
<head>
	<meta charset="utf-8">
	<title>API details documentation | Aulia Arif Wardana</title>
...
<div id="container">
	...
	<div id="body">
        ...
        <p>API Purpose : </p>
		<code>API ini digunakan untuk melakukan registrasi user baru</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/user-register</code>

        <p>Test Case : </p>
		<code>
            {
                "first_name" : "Aulia Wardana",
                "last_name" : "Arif",
                "email" : "auldesain@gmail.com",
                "username" : "aulwardana",
                "password" : "rahasia",
                "role" : "penjual"
            }
