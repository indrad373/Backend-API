...
<div id="container">
	<h1>User Update Password API</h1>
	...
	<div id="body">
        ...
        <p>API Purpose : </p>
		<code>API ini digunakan untuk mengubah password user</code>

		<p>Localhost testing URL : </p>
		<code>http://localhost/api/user-update-password</code>
		...
		<code>
            {
                "Success": true,
    			"Info": "Success Update User Password"
            }
        </code>
